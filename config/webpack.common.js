...
module.exports = {
    ...
    plugins: getMicroFrontPluginsConfig({packageName: "xotomicro_front_order_service", packageDependencies, HtmlWebpackPlugin, EnvironmentPlugin, ModuleFederationPlugin}),
}
